...
namespace ET
{
    public static class EUIHelper
    {
        ...
        public static void AddListener(this InputField inputEield, UnityAction<string> clickEventHandler)
        {
            inputEield.onValueChanged.RemoveAllListeners();
            inputEield.onValueChanged.AddListener(clickEventHandler);
        }
