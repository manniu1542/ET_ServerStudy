...
namespace ET
{
	...
	public partial class EntryRandomConfig: ProtoObject, IConfig
	{
		...
		[ProtoMember(2)]
		public int NormalRandMinCount { get; set; }
		/// <summary>随机词条最大数量</summary>
		[ProtoMember(3)]
		public int NormalRandMaxCount { get; set; }
		/// <summary>随机特殊词条最小数量</summary>
		[ProtoMember(4)]
		public int SpecialRandMinCount { get; set; }
		/// <summary>随机特殊词条最大数量</summary>
		[ProtoMember(5)]
		public int SpecialRandMaxCount { get; set; }
