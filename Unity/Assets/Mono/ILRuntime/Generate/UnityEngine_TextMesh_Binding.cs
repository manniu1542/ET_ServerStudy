...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_TextMesh_Binding
    {
        ...
        static StackObject* set_text_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.TextMesh instance_of_this_method = (UnityEngine.TextMesh)typeof(UnityEngine.TextMesh).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
